...
echo ""
echo "Webhooks:"
echo "  Main:    ${WEBHOOK_URL:-http://localhost:5678}/webhook/instagram-webhook"
echo "  MUDANÇA: ${WEBHOOK_URL:-http://localhost:5678}/webhook/instagram-comment-mudanca"
echo ""
echo "To import workflows:"
echo "  npm run import:all"
echo ""
echo "  Or manually:"
echo "  1. Open n8n in your browser"
echo "  2. Import workflows/social-instagram-agent.json"
echo "  3. Import workflows/comment-mudanca-automation.json"
echo "  4. Configure the Kommo Bearer Auth credential"
echo "  5. Set environment variables in n8n settings"
echo "  6. Activate both workflows"
echo ""
